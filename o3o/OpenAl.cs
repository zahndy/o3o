...
namespace OpenAL
{
    internal static class al : object
    {
        ...
        [DllImport(DLLName, EntryPoint = "alEnable"), SuppressUnmanagedCodeSecurity]
        public static extern void Enable(int capability);

        [DllImport(DLLName, EntryPoint = "alDisable"), SuppressUnmanagedCodeSecurity]
        public static extern void Disable(int capability);

        [DllImport(DLLName, EntryPoint = "alIsEnabled"), SuppressUnmanagedCodeSecurity]
        public static extern bool IsEnabled(int capability);

        [DllImport(DLLName, EntryPoint = "alHint"), SuppressUnmanagedCodeSecurity]
        public static extern void Hint(int target, int mode);

        [DllImport(DLLName, EntryPoint = "alGetString"), SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.LPStr)]
        public static extern string GetString(int param);

        [DllImport(DLLName, EntryPoint = "alGetBoolean"), SuppressUnmanagedCodeSecurity]
        public static extern bool GetBoolean(int param);

        [DllImport(DLLName, EntryPoint = "alGetBooleanv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetBooleanv(int param, bool[] data);

        [DllImport(DLLName, EntryPoint = "alGetInteger"), SuppressUnmanagedCodeSecurity]
        public static extern int GetInteger(int param);

        [DllImport(DLLName, EntryPoint = "alGetIntegerv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetIntegerv(int param, int[] data);

        [DllImport(DLLName, EntryPoint = "alGetFloat"), SuppressUnmanagedCodeSecurity]
        public static extern float GetFloat(int param);

        [DllImport(DLLName, EntryPoint = "alGetFloatv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetFloatv(int param, float[] data);

        [DllImport(DLLName, EntryPoint = "alGetDouble"), SuppressUnmanagedCodeSecurity]
        public static extern double GetDouble(int param);

        [DllImport(DLLName, EntryPoint = "alGetDoublev"), SuppressUnmanagedCodeSecurity]
        public static extern void GetDoublev(int param, double[] data);

        [DllImport(DLLName, EntryPoint = "alGetError"), SuppressUnmanagedCodeSecurity]
        public static extern int GetError();

        [DllImport(DLLName, EntryPoint = "alIsExtensionPresent"), SuppressUnmanagedCodeSecurity]
        public static extern bool IsExtensionPresent([MarshalAs(UnmanagedType.LPStr)] string fname);

        [DllImport(DLLName, EntryPoint = "alGetEnumValue"), SuppressUnmanagedCodeSecurity]
        public static extern int GetEnumValue(byte[] ename);

        [DllImport(DLLName, EntryPoint = "alListeneri"), SuppressUnmanagedCodeSecurity]
        public static extern void Listeneri(int param, int value);

        [DllImport(DLLName, EntryPoint = "alListenerf"), SuppressUnmanagedCodeSecurity]
        public static extern void Listenerf(int param, float value);

        [DllImport(DLLName, EntryPoint = "alListener3f"), SuppressUnmanagedCodeSecurity]
        public static extern void Listener3f(int param, float f1, float f2, float f3);

        [DllImport(DLLName, EntryPoint = "alListenerfv"), SuppressUnmanagedCodeSecurity]
        public static extern void Listenerfv(int param, float[] values);

        [DllImport(DLLName, EntryPoint = "alGetListeneriv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetListeneriv(int param, int[] values);

        [DllImport(DLLName, EntryPoint = "alGetListenerfv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetListenerfv(int param, float[] values);

        [DllImport(DLLName, EntryPoint = "alGenSources"), SuppressUnmanagedCodeSecurity]
        public static extern void GenSources(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alDeleteSources"), SuppressUnmanagedCodeSecurity]
        public static extern void DeleteSources(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alIsSource"), SuppressUnmanagedCodeSecurity]
        public static extern bool IsSource(int id);

        [DllImport(DLLName, EntryPoint = "alSourcei"), SuppressUnmanagedCodeSecurity]
        public static extern void Sourcei(int source, int param, int value);

        [DllImport(DLLName, EntryPoint = "alSourcef"), SuppressUnmanagedCodeSecurity]
        public static extern void Sourcef(int source, int param, float value);

        [DllImport(DLLName, EntryPoint = "alSource3f"), SuppressUnmanagedCodeSecurity]
        public static extern void Source3f(int source, int param, float v1, float v2, float v3);

        [DllImport(DLLName, EntryPoint = "alSourcefv"), SuppressUnmanagedCodeSecurity]
        public static extern void Sourcefv(int source, int param, float[] values);

        [DllImport(DLLName, EntryPoint = "alGetSourcei"), SuppressUnmanagedCodeSecurity]
        public static extern void GetSourcei(int source, int param, int[] value);

        [DllImport(DLLName, EntryPoint = "alGetSourcef"), SuppressUnmanagedCodeSecurity]
        public static extern void GetSourcef(int source, int param, float[] value);

        [DllImport(DLLName, EntryPoint = "alGetSource3f"), SuppressUnmanagedCodeSecurity]
        public static extern void GetSource3f(int source, int param, float[] v1, float[] v2, float[] v3);

        [DllImport(DLLName, EntryPoint = "alGetSourcefv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetSourcefv(int source, int param, float[] values);

        [DllImport(DLLName, EntryPoint = "alSourcePlay"), SuppressUnmanagedCodeSecurity]
        public static extern void SourcePlay(int source);

        [DllImport(DLLName, EntryPoint = "alSourcePause"), SuppressUnmanagedCodeSecurity]
        public static extern void SourcePause(int source);

        [DllImport(DLLName, EntryPoint = "alSourceStop"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceStop(int source);

        [DllImport(DLLName, EntryPoint = "alSourceRewind"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceRewind(int source);

        [DllImport(DLLName, EntryPoint = "alSourcePlayv"), SuppressUnmanagedCodeSecurity]
        public static extern void SourcePlayv(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alSourceStopv"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceStopv(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alSourceRewindv"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceRewindv(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alSourcePausev"), SuppressUnmanagedCodeSecurity]
        public static extern void SourcePausev(int n, int[] sources);

        [DllImport(DLLName, EntryPoint = "alGenBuffers"), SuppressUnmanagedCodeSecurity]
        public static extern void GenBuffers(int n, int[] buffers);

        [DllImport(DLLName, EntryPoint = "alDeleteBuffers"), SuppressUnmanagedCodeSecurity]
        public static extern void DeleteBuffers(int n, int[] buffers);

        [DllImport(DLLName, EntryPoint = "alIsBuffer"), SuppressUnmanagedCodeSecurity]
        public static extern bool IsBuffer(int buffer);

        [DllImport(DLLName, EntryPoint = "alBufferData"), SuppressUnmanagedCodeSecurity]
        public static extern void BufferData(int buffer, int format, byte[] data, int size, int freq);

        [DllImport(DLLName, EntryPoint = "alGetBufferi"), SuppressUnmanagedCodeSecurity]
        public static extern void GetBufferi(int buffer, int param, int[] value);

        [DllImport(DLLName, EntryPoint = "alGetBufferf"), SuppressUnmanagedCodeSecurity]
        public static extern void GetBufferf(int buffer, int param, float[] value);

        [DllImport(DLLName, EntryPoint = "alSourceQueueBuffers"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceQueueBuffers(int source, int n, int[] buffers);

        [DllImport(DLLName, EntryPoint = "alSourceUnqueueBuffers"), SuppressUnmanagedCodeSecurity]
        public static extern void SourceUnqueueBuffers(int source, int n, int[] buffers);

        [DllImport(DLLName, EntryPoint = "alDistanceModel"), SuppressUnmanagedCodeSecurity]
        public static extern void DistanceModel(int value);

        [DllImport(DLLName, EntryPoint = "alDopplerFactor"), SuppressUnmanagedCodeSecurity]
        public static extern void DopplerFactor(float value);

        [DllImport(DLLName, EntryPoint = "alDopplerVelocity"), SuppressUnmanagedCodeSecurity]
    ...
    /// <summary>
    /// Stellt alle OpenAL(alc)-Funktionen bereit.
    /// </summary>
    internal static class alc : object
    {
        ...
        [DllImport(DLLName, EntryPoint = "alcCreateContext"), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr CreateContext(IntPtr device, int[] attrlist);

        [DllImport(DLLName, EntryPoint = "alcMakeContextCurrent"), SuppressUnmanagedCodeSecurity]
        public static extern int MakeContextCurrent(IntPtr context);

        [DllImport(DLLName, EntryPoint = "alcProcessContext"), SuppressUnmanagedCodeSecurity]
        public static extern void ProcessContext(IntPtr context);

        [DllImport(DLLName, EntryPoint = "alcSuspendContext"), SuppressUnmanagedCodeSecurity]
        public static extern void SuspendContext(IntPtr context);

        [DllImport(DLLName, EntryPoint = "alcDestroyContext"), SuppressUnmanagedCodeSecurity]
        public static extern void DestroyContext(IntPtr context);

        [DllImport(DLLName, EntryPoint = "alcGetError"), SuppressUnmanagedCodeSecurity]
        public static extern int GetError(IntPtr device);

        [DllImport(DLLName, EntryPoint = "alcGetCurrentContext"), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr GetCurrentContext();

        [DllImport(DLLName, EntryPoint = "alcOpenDevice"), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr OpenDevice([MarshalAs(UnmanagedType.LPStr)]string deviceName);

        [DllImport(DLLName, EntryPoint = "alcCloseDevice"), SuppressUnmanagedCodeSecurity]
        public static extern void CloseDevice(IntPtr device);

        [DllImport(DLLName, EntryPoint = "alcIsExtensionPresent"), SuppressUnmanagedCodeSecurity]
        public static extern bool IsExtensionPresent(IntPtr device, string extName);

        [DllImport(DLLName, EntryPoint = "alcGetProcAddress"), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr GetProcAddress(IntPtr device, byte[] funcName);

        [DllImport(DLLName, EntryPoint = "alcGetEnumValue"), SuppressUnmanagedCodeSecurity]
        public static extern int GetEnumValue(IntPtr device, byte[] enumName);

        [DllImport(DLLName, EntryPoint = "alcGetContextDevice"), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr GetContextsDevice(IntPtr context);

        [DllImport(DLLName, EntryPoint = "alcGetIntegerv"), SuppressUnmanagedCodeSecurity]
        public static extern void GetIntegerv(IntPtr device, int param, int intsize, out int data);

        [DllImport(DLLName, EntryPoint = "alcGetString"), SuppressUnmanagedCodeSecurity]
    ...
    internal static class alut : object
    {
        ...
        [DllImport(DLLName, EntryPoint = "alutInit"), SuppressUnmanagedCodeSecurity]
        public static extern void Init(IntPtr argc, IntPtr argv);

        [DllImport(DLLName, EntryPoint = "alutExit"), SuppressUnmanagedCodeSecurity]
        public static extern void Exit();

        [DllImport(DLLName, EntryPoint = "alutLoadWAVFile"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(DLLName, EntryPoint = "alutUnloadWAV"), SuppressUnmanagedCodeSecurity]
        public static extern void UnloadWAV(int format, IntPtr data, int size, int frequ);
    }
#endif

    public class ContextAL : object, IDisposable
    {
        ...
        public void Dispose()
        {
            if ((FContext == (IntPtr)0) || (FDevice == (IntPtr)0))
                return;
